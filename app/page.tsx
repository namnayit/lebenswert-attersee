  ...
  return (
    <div className="overflow-hidden">
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="absolute flex justify-center flex-col top-4 md:top-10 w-full h-auto p-2 md:p-1 bg-cyan-700 z-100 shadow rounded-md">
          ...
          >
            <MdOutlineAttachEmail
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl 3xl:text-6xl"
            />
            <a href="mailto:info@lebenswert-attersee.at" className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 3xl:text-5xl ml-2 underline">
          ...
          >
            <div className="flex flex-col sm:flex-row gap-2 md:gap-4 text-base sm:text-lg md:text-xl xl:text-2xl 3xl:text-3xl">
              ...
              <motion.p
                ...
                className={`cursor-pointer ${activeButton === "obg" ? "underline" : ""} font-semibold text-center sm:text-left`}
                transition={{}}
              >
                Ortsbildgutachten
              </motion.p>
              ...
              <motion.p
                ...
                className={`cursor-pointer ${activeButton === "pw" ? "underline" : ""} font-semibold text-center sm:text-left`}
              >
                Postwurf
              </motion.p>
            </div>
        ...
        >
          <p className="self-center bg-black/30 p-4 rounded-lg backdrop-blur-sm">{text}</p>
        </motion.div>
      </div>
    </div>
  );
